...
class PointNet2(nn.Module):
    ...
    def forward(self, input):
        ...
        l2_features = self.fp_module_1(l2_xyz, l3_xyz, l2_features, l3_features) # [16, 256, 128]
        l1_features = self.fp_module_2(l1_xyz, l2_xyz, l1_features, l2_features) # [16, 128, 512]
        l0_features = self.fp_module_3(l0_xyz, l1_xyz, l0_features, l1_features) # [16, 128, 1024]
