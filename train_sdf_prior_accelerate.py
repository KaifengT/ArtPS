...
if args.dataset == 'hoi4d':
    ...
    assert args.category in ['C3', 'C4', 'C6', 'C8', 'C14', 'C17'], f'Invalid category {args.category} for HOI4D dataset.'
...
decoder_helpers = accelerator.unwrap_model(decoder)
...
for epoch in range(0, max_epoch):
    ...
    for i, data in enumerate(train_dataloader):
        ...
        with accelerator.accumulate(encoder, decoder):
            ...
            sdf_meta = decoder(instance_code, sample)
            ...
            loss_joint = decoder_helpers.joint_loss(
            ...
            if predict_bbox:
                ...
                bbox_loss = decoder_helpers.bbox_loss(
            ...
            loss = loss_sdf + code_loss + loss_joint + bbox_loss
            ...
            if accelerator.sync_gradients:
                ...
                accelerator.clip_grad_norm_(encoder.parameters(), 1.0)
            optimizer.step()
            scheduler.step()
            ...
            bar.set_postfix({'loss': f'{loss.item():.5f}', 'epoch': f'{best_epoch}|{epoch}|{max_epoch}'})
            bar.update(1)
    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(test_dataloader):
            ...
            gathered_loss_sdf, gathered_loss_joint, gathered_loss_bbox = accelerator.gather_for_metrics([loss_sdf, loss_joint, bbox_loss])
        ...
        if accelerator.is_main_process:
            ...
            all_loss = sdf_loss + loss_joint + bbox_loss
            print(all_loss)
